        ...
        <div className="container">
          <div className="row g-3">
            <div className="col-6 col-lg-3">
              <div className="stats-card h-100 d-flex flex-column justify-content-center">
                <span className="stats-number">32%</span>
                <span className="stats-text">de economia com combustível</span>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-3">
              <div className="stats-card h-100 d-flex flex-column justify-content-center">
                ...
                <span className="stats-text">
                  de produtividade com a sua frota
                </span>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-3">
              <div className="stats-card h-100 d-flex flex-column justify-content-center">
                ...
                <span className="stats-text">de evasão de clientes*</span>
              </div>
            </div>
          </div>
          <p className="text-white-50 small mt-2">
            *Resultados ilustrativos baseados em ganhos médios de eficiência com o uso de
            plataformas de rastreamento inteligente.
          </p>
        </div>
      </div>
    </div>
...
function SolutionsSection() {
  return (
    <section className="section-padding solutions-section" id="solucoes">
        ...
        <div className="container">
          <div className="text-center mb-4">
            <h2 className="section-title">
              Soluções personalizadas para diferentes tipos de empresas
            </h2>
            <p className="section-subtitle text-muted">
              Da pequena operação de entregas à grande frota corporativa, a SafeRide
              adapta o rastreamento à realidade do seu negócio.
            </p>
          </div>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="solution-card">
                ...
                <h5 className="solution-title">PME</h5>
                <p className="solution-text mb-0">
                  Ideal para empresas em crescimento que buscam otimizar a frota com um
                  orçamento acessível e visão clara do dia a dia dos veículos.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="solution-card">
                <div className="solution-icon">📈</div>
                <h5 className="solution-title">Grandes Empresas</h5>
                <p className="solution-text mb-0">
                  Soluções customizadas para grandes frotas, com múltiplas filiais,
                  integrações e necessidades mais complexas de operação.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="solution-card">
                ...
                <h5 className="solution-title">Projetos Especiais</h5>
                <p className="solution-text mb-0">
                  Projetos sob medida para setores específicos, como cargas especiais,
                  máquinas, locadoras, moto-entrega e muito mais.
                </p>
              </div>
            </div>
          </div>
...
function WhatsAppButton() {
  const message = encodeURIComponent(
    "Olá, gostaria de saber mais sobre o rastreamento da SafeRide."
  );

  // TROCAR PELO SEU NÚMERO COM DDI+DDD (ex: 5579991234567)
  const phone = "5579933002468";
  ...
  return (
    <a
      ...
      aria-label="Fale com a SafeRide no WhatsApp"
    >
